...
<main>
	<div class="modal">
		...
		<h1 class="modal__heading">Hier kannst du deinen Code eingeben!</h1>
		<p>Du hast noch keinen Code? Versuche, das richtige Los zu entdecken.</p>
		<div class="email-box">
<form action="versuchx.html" method="get">
			<input type="text" class="email-box__input" placeholder="Geschenk Code" onKeyPress="KeyCode;" value="<?php echo !empty($code) ? $code : '' ?>"/>
			<button type="submit" class="email-box__button"><i class="ion-paper-airplane"></i></button>
</form>	<?php
